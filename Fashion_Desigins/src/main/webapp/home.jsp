    ...
    <section class="section statistics">
      ...
      <div class="row container">
        <div class="col">
          ...
          <p>An easy order system streamlines the process of ordering products or services, making it convenient and efficient for customers.</p>
        </div>
        <div class="col">
          <div class="icon">
          ...
          <p>Timely delivery of goods or services as promised or expected, without delays or lateness.</p>
        </div>
        <div class="col">
          <div class="icon">
          ...
          <p>Once We receives and inspects the returned product, they will initiate the refund. The refund can be in the form of  bank transfer, or other methods, depending on your preference and the circumstances.</p>
        </div>
        <div class="col">
          <div class="icon">
            <i class="bx bxs-user"></i>
          ...
          <p>Customers can reach out to the company's customer service team at any time of the day or night, including weekends and holidays, for help, inquiries, or problem resolution.</p>
        </div>
      </div>
    </section>
